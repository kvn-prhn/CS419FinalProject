    ...
    <div class="ribbon l-box-lrg pure-g " style = "padding-bottom:60px" >
        <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-3-5">
			<div class = "pure-u-4-10">
				...
				Use of this website is subject to our <a class="home-links-page" href="term_and_conditions.jsp">Terms & Conditions</a> 
				and <a class="home-links-page"  href="privacy_policy.jsp">Privacy Policy</a>. </p>
			</div>
